...
1. Decide baseline airframe architecture.
   - Status: `Not started`
   - Owner: `Mixed`
...
- `2026-08-31`: Accepted first-aircraft requirements baseline for GitHub issue `#1` in `requirements/first-aircraft-requirements.md`; updated roadmap/task state and archived the handoff.
